export const projectsData = [
  {
    ...
    results: [
      { label: 'Engagement Lift', value: '+240%' },
      { label: 'Conversions', value: '+182%' },
      { label: 'UX Satisfaction', value: '92%' },
    ],
  },
  {
    id: 'innofjoy',
    ...
    visual: 'quote',
    quoteText: 'Stay where quiet lives.',
    quoteFooter: 'NOIDA · IN / EST. 2024',
    role: 'End-to-end: brand positioning, UX, visual design, copy, and direct booking funnel.',
    challenge:
      'Independent hotels lose huge margin to aggregator platforms. The site needed to convert direct bookings while staying premium, local, and trustworthy.',
    solution:
      'A clean, photography-led website with a frictionless room selector, transparent pricing, local SEO foundations, and a booking flow tuned to the realities of mobile-first travel research.',
    stack: 'Webflow · CMS · Booking Engine · Local SEO',
    results: [
      { label: 'Direct Bookings', value: '+3.1×' },
  ...
  },
  {
    ...
    gridSpan: 'lg:col-span-2',
    visual: 'mountain',
    role: 'Concept, narrative direction, art direction, and interactive prototype.',
    challenge:
  ...
  },
  {
    ...
    year: '2026',
    description:
      'An AI-powered analytics and automation product currently in private build. Sign up to get notified when we open early access.',
    ...
    results: [
      { label: 'Private Beta', value: 'Q3' },
      { label: 'Public Launch', value: '2026' },
      { label: 'Early Access', value: 'Soon' },
    ],
  },
];
